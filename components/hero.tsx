      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-2xl sm:text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-500 mb-6"
          >
          ...
          <motion.p
            ...
            className="text-gray-400 text-md  md:text-xl mb-8 max-w-2xl mx-auto"
          >
          ...
          <div className="flex gap-4">
              ...
              <button className="md:px-3 md:py-4 px-1 py-1 text-sm md:text-md   rounded-full bg-[#1ED760] font-bold text-white tracking-widest uppercase transform hover:scale-105 hover:bg-[#21e065] transition-colors duration-200">
                Browse Components
              </button>
               </Link>
               <Link  href="/template">
             
              <button className="md:px-3 md:py-4 px-1 py-1 text-sm md:text-md  rounded-full bg-[#1e7ed7] font-bold text-white tracking-widest uppercase transform hover:scale-105 hover:bg-[#1e7ed9] transition-colors duration-200">
                Browse Templates
              </button>
               </Link>

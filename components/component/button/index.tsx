...
export default function ModernButton({
  ...
  return (
    <div className={preview ? "flex flex-col items-center gap-4" : undefined}>
      {preview && (
        <p className="text-sm text-gray-500">
          Showcase: A modern gradient button with smooth animations.
        </p>
      )}
      <button
        className={cn(
      ...
      >
        <span className="relative z-10 bg-gradient-to-r from-[#FF3BFF] via-[#ECBFBF] to-[#5C24FF] bg-clip-text text-transparent">
          {children || "Click Me"} {/* Default text if no children provided */}
